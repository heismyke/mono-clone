...
const GettingStarted = () => {
  ...
  return (
    <div className="w-[100%] bg-blue-300 flex flex-col py-16 items-center justify-center">
      <div className="w-[90%] xl:w-[80%] my-5">
        <h1 className="text-[45px] font-DMsans text-white xl:text-[65px] font-semibold ">
          Getting started
        </h1>
      </div>
      <div className="w-[90%] md:w-[90%] lg:w-[90%] xl:w-[80%] rounded-xl bg-white lg:pt-16 flex flex-col lg:flex-row">
        <div className="p-5 flex flex-col gap-4 xl:pl-16">
          <img src={Plug} width={70} height={70} alt="mono thumbnail" />
          <h2 className="font-medium font-DMsans text-[35px] max-w-[70%] md:text-[45px] lg:max-w-[97%] xl:max-w-[66%] md:max-w-[40%]">
            Powerful APIs and easy-to-use resources
          </h2>
          <a href="" className="flex items-center gap-3 text-blue-600">
            Read our API docs <FiArrowUpRight className="text-blue-800" />
          </a>
        </div>
      ...
      <div className="w-[90%] xl:w-[80%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-10 gap-5">
